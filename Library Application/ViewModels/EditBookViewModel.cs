...
{
    internal class EditBookViewModel : ViewModelBase, INotifyDataErrorInfo
    {
        // public
        ...
        public EditBookViewModel(Session session, Navigation navigation, Book book)
        {
            ...
            title = book.Title;
            publish_date = book.PublishYear;
            stock = Convert.ToString(book.Stock);
            authors = new ObservableCollection<Author>(DBUtils.getBookAuthors(book.Id));
...
#pragma warning disable CS8601 // Possible null reference assignment.
            book_type = all_book_types.FirstOrDefault(book_type => book_type.Id == book.BookType.Id);
...
#pragma warning restore CS8601 // Possible null reference assignment.
            ...
            AddAuthor = new EditBookCommand(navigation, "addauthor");
            RemoveAuthor = new EditBookCommand(navigation, "removeauthor");

            CreateCommand = new EditEntityCommand("book", "edit", session, navigation);
            CancelCommand = new EditEntityCommand("book", "cancel", session, navigation);
        }
