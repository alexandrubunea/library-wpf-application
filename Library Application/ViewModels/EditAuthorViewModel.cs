...
{
    internal class EditAuthorViewModel : ViewModelBase, INotifyDataErrorInfo
    {
        // public
        public ICommand AuthorEdit { get; }
...
#pragma warning restore CS8620 // Argument cannot be used for parameter due to differences in the nullability of reference types.
        ...
        public EditAuthorViewModel(Session session, Navigation navigation, Author author)
        {
            AuthorEdit = new EditEntityCommand("author", "edit", session, navigation);
            CancelEdit = new EditEntityCommand("author", "cancel", session, navigation);
